...
| `Obscenity_Trade_Networks_All_Connections.csv` | All 250 connections with descriptions and sources. |
...
**Obscenity_Trade_Networks_All_Connections.csv** contains 250 records with the following variables:
